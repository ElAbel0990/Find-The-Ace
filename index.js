...
/*<dic class="card">
    <div class="card-inner">
        ...
        <div class="card-back">
            <img src="images/card-back-Red.png" alt="" class="card-img" />
        </div>
    </div>
</dic> */
...
function canChooseCard() {
  return gameInPorgress == true && !shufflingInProgress && !cardsRevealed;
}
...
function checkForIncompleteGame() {
  ...
  if (serializedGameObj) {
    ...
    if (gameObj.round >= maxRounds) {
      ...
      if (confirm("Would you like to continue with your game?")) {
        score = gameObj.score;
...
function createCard(cardItem) {
  //creat div elements that make up a card
  const cardElem = createElement("div");
  const cardInnerElem = createElement("div");
  const cardFrontElem = createElement("div");
  const cardBackElem = createElement("div");

  //creat fornt and back image elemts for a card
  ...
  //add src attribut and appropriate value to img element - back of card
  addSrcToImageElem(cardBackImg, cardBackImgPath);

  //add src attribute and appropriate value to img element - front of card
  addSrcToImageElem(cardFrontImg, cardItem.imagePath);

  //assign class to back image element of bakc of card
  ...
  //add inne card element as child element to card element
...
function saveObjectToLocalStorage(score, round) {
  ...
  updateLocalStorageItem(
    localStorageGameKey,
    getSerializedObectAsJSON(gameObj)
  );
}
